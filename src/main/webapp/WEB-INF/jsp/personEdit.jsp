	...
	<%--<% if(session.isNew())--%>
		...
		<div class="container">
			...
			<div class="col-md-10">
				...
				<div class="col-md-9">					
					<form:form action="editPerson" method="post" style=" width: 80%;" modelAttribute="person">
							<form:hidden class="form-control EditInput" path="usernum"/>

							<div class="form-group has-success">
								姓名：<form:input class="form-control EditInput" path="username"/>
							</div>
							<div class="form-group has-success">
								性别：<form:input class="form-control EditInput" path="gender" />
							</div>
						<c:if test="${personCategory==2}">
						<div class="form-group has-success">
							所管工具类别：
							<%--<form:input class="form-control EditInput" path="gender" />--%>
