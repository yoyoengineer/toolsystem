    ...
    <div class="col-md-10">
        ...
        <%--<div>--%>
            <%--<table class="table table-hover">--%>
                ...
                <%--<c:forEach var="person" items="${people}" >--%>
                    <%--<c:if test="${person.getCategory()==2}">--%>
                        <%--<tr>--%>
        ...
        <div class="pull-right">
            ...
            <ul class="pagination pagination-minimal">
                <li class="previous">
                    <a href="usersDisplay/${pager.currentPage-1}"><</a>
                </li>
                <c:forEach var="i" begin="1" end="${pager.totalPage}" step="1">
                    <li>
                        <a href="usersDisplay/${i}"><c:out value="${i}"/></a>
                    </li>
                </c:forEach>
                <li class="next">
                    <a href="usersDisplay/${pager.currentPage+1}">></a>
